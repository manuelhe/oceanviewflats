...
export const CalendarWidgetWarm = ({ lang, checkIn, checkOut, onSelectDate }: CalendarWidgetProps) => {
  ...
  for (let i = 1; i <= daysInMonth; i++) {
    ...
    let bgClass = "bg-white hover:bg-stone-100 text-stone-700";
    if (isPast) {
      bgClass = "bg-transparent text-stone-300 cursor-not-allowed";
    } else if (isCheckIn || isCheckOut) {
      bgClass = "bg-rose-600 text-white";
    } else if (isInRange) {
      bgClass = "bg-rose-600/10 text-rose-600";
    }
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <div id="month-label" className="font-bold text-lg text-stone-800">
