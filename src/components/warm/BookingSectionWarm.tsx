          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-10 flex flex-col justify-center">
              ...
              <div id="price-breakdown-card" className="hidden bg-stone-50 p-6 rounded-2xl border border-stone-200 mb-6 transition-all duration-300">
                <h4 className="font-bold text-stone-800 text-sm mb-4 uppercase tracking-wider">{t.dbPriceBreakdown}</h4>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between text-stone-600">
                    <span id="rate-breakdown-label">{t.dbAccommodation}</span>
                    <span id="rate-breakdown-value" className="font-semibold text-stone-900" data-nights-format={t.dbNightsFormat}>0 COP</span>
                  </div>
                  <div className="flex justify-between text-stone-600">
                  ...
                  <div className="flex justify-between items-baseline">
                    <span className="font-bold text-stone-800">{t.dbTotal}</span>
                    <div className="text-right">
                      ...
                      <div id="converted-currency-box" className="hidden text-xs text-stone-500 mt-1">
                        ...
                        <span id="currency-tooltip-trigger" className="inline-block ml-1 cursor-help text-stone-400 hover:text-stone-600" title={t.dbDisclaimer}>ⓘ</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <form id="direct-booking-form" className="hidden space-y-4 mb-6 transition-all duration-300">
                <h4 className="font-bold text-stone-800 text-sm uppercase tracking-wider">{t.dbFormTitle}</h4>
                ...
                <div>
                  <label className="block text-xs font-bold text-stone-500 uppercase tracking-wide mb-1">{t.dbName}</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-stone-500 uppercase tracking-wide mb-1">{t.dbEmail}</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-stone-500 uppercase tracking-wide mb-1">{t.dbPhone}</label>
                ...
                <div className="bg-stone-50 p-4 rounded-xl border border-stone-200 grid grid-cols-2 gap-4 items-center">
                  <div>
                    <label id="booking-captcha-label" className="block text-xs font-bold text-stone-500 uppercase tracking-wide mb-1">{t.dbVerify}</label>
                    <input type="text" id="booking-captcha-response" required className="w-full p-2 rounded-lg border border-stone-200 text-stone-800 text-sm focus:outline-none focus:border-[#FF5A5F]" placeholder="..." />
