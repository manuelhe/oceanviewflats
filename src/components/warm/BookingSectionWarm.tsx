          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-10 flex flex-col justify-center">
              ...
              <a 
                ...
                className="w-full flex items-center justify-center space-x-2 bg-rose-600 hover:bg-[#FF424D] text-white py-4 rounded-xl font-bold text-lg transition-transform hover:scale-[1.02] shadow-lg mb-6"
