          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-10 flex flex-col justify-center">
              ...
              <div id="price-breakdown-card" className="hidden bg-slate-50 p-6 rounded-2xl border border-slate-200 mb-6 transition-all duration-300">
                <h4 className="font-bold text-slate-800 text-sm mb-4 uppercase tracking-wider">Detalle del precio / Price Breakdown</h4>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between text-slate-600">
                    <span id="rate-breakdown-label">Hospedaje / Accommodation</span>
                    <span id="rate-breakdown-value" className="font-semibold text-slate-900">0 COP</span>
                  </div>
                  <div className="flex justify-between text-slate-600">
                  ...
                  <div className="flex justify-between items-baseline">
                    ...
                    <div className="text-right">
                      ...
                      <div id="converted-currency-box" className="hidden text-xs text-slate-500 mt-1">
                        ...
                        <span id="currency-tooltip-trigger" className="inline-block ml-1 cursor-help text-slate-400 hover:text-slate-600" title="Informational estimate only. The transaction is processed in COP.">ⓘ</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <form id="direct-booking-form" className="hidden space-y-4 mb-6 transition-all duration-300">
                <h4 className="font-bold text-slate-800 text-sm uppercase tracking-wider">Reserva Directa / Direct Booking</h4>
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-1">Nombre Completo / Full Name *</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-1">Teléfono / Phone *</label>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 grid grid-cols-2 gap-4 items-center">
                  <div>
                    <label id="booking-captcha-label" className="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-1">Verificación / Solve *</label>
                    <input type="text" id="booking-captcha-response" required className="w-full p-2 rounded-lg border border-slate-200 text-slate-800 text-sm focus:outline-none focus:border-[#FF5A5F]" placeholder="Respuesta" />
