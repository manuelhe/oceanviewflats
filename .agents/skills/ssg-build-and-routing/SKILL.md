...
3. **HTML Generator Loop**:
   * Reads all declared page routes in [`src/config/pages.ts`](file:///Users/manuel.herrera/Projects/17071606/src/config/pages.ts).
...
4. **Master Template Wrap**: Injects the React string output, hreflang alternate links, detailed schema markup, and canonical tags into [`src/templates/base.ts`](file:///Users/manuel.herrera/Projects/17071606/src/templates/base.ts).
...
All routes must be centrally defined inside [`src/config/pages.ts`](file:///Users/manuel.herrera/Projects/17071606/src/config/pages.ts).
